...
func TestImage_DrawText(t *testing.T) {
	...
	im, _ = im.DrawText("HellogA2020东京奥运会", fc, metrics, imaging.TopLeft, 0, 0)
	im, _ = im.DrawText("HellogA2020东京奥运会", fc, metrics, imaging.Left, 0, 0)
	im, _ = im.DrawText("HellogA2020东京奥运会", fc, metrics, imaging.BottomLeft, 0, 0)
	im, _ = im.DrawText("奥运会", fc, metrics, imaging.Top, 0, 0)
	im, _ = im.DrawText("奥运会", fc, metrics, imaging.TopRight, 150, 0)
	im, _ = im.DrawText("奥运会", fc, metrics, imaging.Center, -75, 0)
	im, _ = im.DrawText("奥运会", fc, metrics, imaging.Bottom, 0, 0)
	im, _ = im.DrawText("奥运会", fc, metrics, imaging.BottomRight, 150, 0)
